...
## Technical Details
- **Renderer**: P2D
- **Simulation**: analytic sinusoidal wave surface
- **Visuals**: vector Snell's law refraction, bincount photon-density accumulation, three-zone tone mapping (floor / glow / flare), tile grid compositing
