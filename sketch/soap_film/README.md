...
## Technical Details
- **Renderer**: P2D
- **Simulation**: 6-octave fBm thickness field (0–680 nm)
- **Visuals**: 21-wavelength spectral integration of I(λ)=½(1−cos(4πnt/λ)) with CIE sensitivity curves, saturation boost + power-law tone map
