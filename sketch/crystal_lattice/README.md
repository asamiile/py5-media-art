...
## Technical Details
- **Renderer**: P2D
- **Simulation**: reciprocal lattice Fourier transform
- **Visuals**: structure factor with multi-atom basis, Debye-Waller damping, Gaussian spot rendering, Laue zone rings
