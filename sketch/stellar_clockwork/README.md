...
## Technical Details
- **Renderer**: P2D
- **Simulation**: Nested epicyclic tracers (P2D)
- **Visuals**: harmonic resonance tuning, high-persistence trace accumulation, spectral metal coloring (Gold/Silver/Copper)
