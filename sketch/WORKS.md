...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Lorenz Mod 1 chaotic system.
- **Techniques**: The Lorenz Mod 1 strange attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The complex swirling paths are rotated and orthographically projected onto the 2D plane, continuously modulating the parameter `d` over time.
- **Palette**: Teal, Coral, and Amber.

## kinetic_wei_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Wei chaotic system.
- **Techniques**: The Wei strange attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The complex spiraling orbits are rotated and orthographically projected onto the 2D plane, continuously modulating the parameter `b` over time.
- **Palette**: Crimson, Peach, and Cream.
...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Sprott Case S chaotic system.
- **Techniques**: The Sprott Case S chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Violet, Lime, and Copper.
...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Sprott Case Q chaotic system.
- **Techniques**: The Sprott Case Q chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Ocean, Amber, and Slate.

## kinetic_sprott_case_p_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Sprott Case P chaotic system.
- **Techniques**: The Sprott Case P chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Rose, Charcoal, and Mint.

## kinetic_sprott_case_o_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D visualization of the Sprott Case O chaotic system.
- **Techniques**: The Sprott Case O chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Plum, Coral, and Ash.

## kinetic_sprott_case_n_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: An elegant kinetic 3D visualization of the Sprott Case N chaotic system.
- **Techniques**: The Sprott Case N chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Rust, Mustard, and Ivory.

## kinetic_sprott_case_m_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A vibrant kinetic 3D visualization of the Sprott Case M chaotic system.
- **Techniques**: The Sprott Case M chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Teal, Magenta, and Indigo.

## kinetic_sprott_case_l_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A striking kinetic 3D visualization of the Sprott Case L chaotic system.
- **Techniques**: The Sprott Case L chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The orbits are gracefully rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Rose, Gold, and Onyx.

## kinetic_sprott_case_k_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A luxurious kinetic 3D visualization of the Sprott Case K chaotic system.
- **Techniques**: The Sprott Case K chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The orbits are gently rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Ruby, Pearl, and Charcoal.

## kinetic_sprott_case_j_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A vivid kinetic 3D visualization of the Sprott Case J chaotic system.
- **Techniques**: The Sprott Case J chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The mesmerizing orbits are gently rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Emerald, Topaz, and Sapphire.

## kinetic_sprott_case_i_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A sleek kinetic 3D visualization of the Sprott Case I strange attractor.
- **Techniques**: The Sprott Case I chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gently rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Silver, Amber, and Obsidian.

## kinetic_sprott_case_h_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D exploration of the Sprott Case H chaotic system.
- **Techniques**: The Sprott Case H chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The dynamic orbits are gently rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Crimson, Navy, and Slate.

## kinetic_sprott_case_g_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D exploration of the Sprott Case G chaotic system.
- **Techniques**: The Sprott Case G chaotic flow. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The mesmerizing orbits are gently rotated in 3D and orthographically projected onto the 2D plane, continuously modulating the parameter `a` over time.
- **Palette**: Rose, Violet, and Gold.
...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A kinetic 3D volumetric visualization of the Liu strange attractor.
- **Techniques**: We numerically integrate the Liu differential equations using the Euler method for 1M particles. The dynamic parameters cause the highly-structured strange attractor to stretch and breathe. The particles undergo continuous 3D rotation and orthographic projection onto the 2D plane.
- **Palette**: Violet, Magenta, and Gold.

## kinetic_rossler_hyperchaos_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 4D hyperchaotic flow exploring higher-dimensional chaos.
- **Techniques**: The Rössler Hyperchaos Attractor. We numerically integrate the continuous 4D differential equations using the Euler method for 1M particles. The 4th dimension drives complex hyperchaotic perturbations while we rotate and orthographically project the 3D subspace `(x, y, z)` onto the 2D plane, gently modulating the parameter `d` over time.
- **Palette**: Indigo, Sapphire, and Silver.
...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow featuring beautiful swirling orbits.
- **Techniques**: The T System Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The delicate tangled orbits are rotated and orthographically projected onto the 2D plane, gently modulating the parameter `c` over time.
- **Palette**: Rose, Peach, and Azure.
...
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming beautifully twisted cyclic structures.
- **Techniques**: The Arneodo Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The delicate swirling structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `a` over time.
- **Palette**: Peach, Indigo, and Mint.

## kinetic_hindmarsh_rose_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow simulating the bursting behavior of neurons.
- **Techniques**: The Hindmarsh-Rose Model. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The neuronal bursts form a chaotic 3D attractor that is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `I` over time.
...
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Genesio-Tesi Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `c` over time.
- **Palette**: Violet, Chartreuse, and Slate.

## kinetic_dequan_li_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Dequan Li Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `a` over time.
- **Palette**: Magenta, Cyan, and White.

## kinetic_newton_leipnik_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Newton-Leipnik Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `a` over time.
- **Palette**: Teal, Coral, and Cream.

## kinetic_shimizu_morioka_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Shimizu-Morioka Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `a` over time.
...
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Sprott-Linz S Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `alpha` over time.
- **Palette**: Electric Blue, Purple, and Hot Pink.

## kinetic_sprott_linz_r_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Sprott-Linz R Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `alpha` over time.
- **Palette**: Cyan, Magenta, and White.

## kinetic_sprott_linz_q_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Sprott-Linz Q Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `alpha` over time.
- **Palette**: Tangerine, Crimson, and Amber.

## kinetic_sprott_linz_p_attractor_2d
- **Date**: 2026-07-26
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuous 3D chaotic flow forming an intricate and elegant shape.
- **Techniques**: The Sprott-Linz P Attractor. We numerically integrate the continuous differential equations using the Euler method for 1M particles. The elegant structure is rotated and orthographically projected onto the 2D plane, gently modulating the parameter `alpha` over time.
- **Palette**: Chartreuse, Olive, and Forest Green.
...
- **Date**: 2026-07-23
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A pulsing topographical map where the elevation lines are driven by interfering sine waves and noise, glowing with holographic neon colors.
- **Techniques**: Evaluates a mathematical interference pattern across a dense grid, wrapping fractional values to extract contour lines. Holographic gradients are mapped directly to pixel buffers.
- **Palette**: Dark blue/grey void, intensely glowing Holographic Cyan and Magenta.
...
- **Date**: 2026-07-06
- **Type**: Animation
- **Concept**: A 2D projection of a 3D terrain built from Delaunay triangulation. The terrain heights are driven by 3D Perlin noise that shifts over time, causing the mountains to smoothly morph and roll like waves.
- **Techniques**: Generates a grid of points, displaces them based on noise, and triangulates using scipy.spatial.Delaunay. The triangles are filled with colors mapped to their average height, creating a low-poly aesthetic.
- **Palette**: Synthwave sunset. Deep purple and neon blue valleys transitioning to hot pink and vibrant orange peaks against a dark sky.

## generative_mandala_kaleidoscope_2d
- **Date**: 2026-07-06
- **Type**: Animation
- **Concept**: A generative mandala that builds itself layer by layer from the center outwards. It uses kaleidoscopic symmetry where complex procedural ornaments (petals, rings, dots) continuously morph, expand, and rotate at different speeds.
- **Techniques**: Radial symmetry achieved through push_matrix, rotate, and scale. The ornaments are driven by multiple overlapping sine waves (Lissajous-like parameters) to give a breathing, organic feel to the geometry.
- **Palette**: Neon on black. Intensely bright magenta, cyan, and yellow layers that overlap with additive blending (screen/add mode).

## generative_l-system_fractal_canopy_2d
- **Date**: 2026-07-06
- **Type**: Animation
- **Concept**: A fractal canopy generated by an L-system grows over time. The branching angles slowly sway as if blown by a gentle breeze. As it grows, the colors transition from deep wood browns at the base to vibrant autumn leaf colors at the tips.
- **Techniques**: A recursive tree drawing function. The recursion depth and wind angle are animated over time using Perlin noise.
- **Palette**: Autumn forest. Deep espresso brown, burnt orange, goldenrod, and crimson on a soft cream background.

## kinetic_reaction_diffusion_cellular_automata_2d
- **Date**: 2026-07-06
- **Type**: Animation
- **Concept**: A reaction-diffusion simulation where two chemicals interact to form organic stripes and spots.
- **Techniques**: Gray-Scott model simulation on a numpy grid, rendered as an upscaled pixel array in py5.
- **Palette**: Bioluminescent alien flora. Deep dark background with glowing cyan and neon pink patterns based on chemical concentration.
...
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A 3D Torus Knot (p=3, q=7) rendered purely in 2D using custom 3D rotation matrices and perspective projection to circumvent hardware 3D rendering bugs.
- **Techniques**: Generates 80,000 points forming a thick "tube" around the mathematical knot. Applies 3D rotation and perspective division, then sorts the points by depth (Painter's algorithm) to draw them back-to-front, creating a perfect illusion of voluminous 3D geometry using only 2D circles.
- **Palette**: "Iridescent Hologram": The tube shimmers through cyan, magenta, and yellow, with depth-based brightness fading into the dark background to create a volumetric fog effect.

## kinetic_math_topological_contour_flow_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A generative topographic map where 15,000 glowing particles continuously trace the contour lines of an unseen, slowly shifting 3D Perlin noise landscape.
- **Techniques**: Computes the 2D gradient of a Perlin noise field and rotates the vectors by 90 degrees to find the contour direction. Particles flow perfectly perpendicular to the gradient, drawing out intricate, shifting topographic rings and valleys.
- **Palette**: "Neon Topography": Electric purple and bright pink particles leaving glowing trails against a very dark, near-black background.

## kinetic_math_strange_attractor_peter_de_jong_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A visualization of the Peter de Jong strange attractor, an iterative chaotic map. Over time, the parameters of the equations slowly drift, causing the attractor's shape to continuously fold, unfold, and evolve into new intricate fractal patterns.
- **Techniques**: Computes 500,000 points per frame using vectorized NumPy arrays by simulating 10,000 independent parallel trajectories. Renders the massive point cloud using additive blending and a slight motion blur trail.
- **Palette**: "Stellar Dust": Bright, glowing golden and orange points scattered across a deep midnight blue background, giving the appearance of cosmic dust or a glowing nebula.

## kinetic_physics_cloth_simulation_wind_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A physics-based simulation of a massive sheet of cloth blowing in an invisible, turbulent wind. The fabric bends, folds, and ripples dynamically.
- **Techniques**: Verlet integration for rigid distance constraints applied across a 60x40 grid of interconnected points. The wind force is driven by Perlin noise, pushing the cloth organically while the top edge remains partially pinned.
- **Palette**: "Shimmering Silk": The fabric color shifts from deep purple and cyan to bright magenta based on the velocity of each section, contrasted against a warm, muted copper background.

## kinetic_organic_reaction_diffusion_coral_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A simulation of the Gray-Scott reaction-diffusion model, creating organic, coral-like structures that slowly grow, pulse, and shift across the screen.
- **Techniques**: Numerically integrates the reaction-diffusion partial differential equations using heavily vectorized NumPy operations (`np.roll`) on a lower-resolution grid for high performance. The parameters dynamically oscillate, causing the growth patterns to breathe and morph over time. The chemical concentrations are directly mapped to pixel colors using `img.np_pixels`.
- **Palette**: A deep ocean teal background contrasting with bright, glowing coral pink and orange cellular structures.

## kinetic_physics_magnetic_pendulum_chaos_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A visualization of the classic "magnetic pendulum" physics problem. 200 pendulums swing over four magnets, tracing chaotic, fractal-like paths driven by gravity, magnetism, and friction.
- **Techniques**: A custom physics engine running multiple numerical integration steps per frame. Pendulum trajectories are drawn with motion blur, and their colors are dynamically mapped to the nearest dominant magnet at each moment in time.
- **Palette**: Deep black background with sharp, vivid primary and secondary colors (Red, Green, Cyan, Purple) blending together through additive synthesis.

## kinetic_organic_recursive_fractal_tree_wind_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A majestic recursive fractal tree that sways organically as if blowing in a strong wind, generating thousands of dynamic branches.
- **Techniques**: A deeply recursive branching algorithm (depth 12) combining spatial coordinates and time via 1D Perlin noise to calculate dynamic wind angles. Additive blending creates a glowing effect at the denser, overlapping tips of the tree.
- **Palette**: "Autumn glowing": Dark brown, thick trunks fading into bright red, orange, and yellow glowing tips against a deep forest green background.

## kinetic_abstract_geometric_kaleidoscope_mandala_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A slowly rotating, procedurally generated mandala that functions like a kaleidoscope.
- **Techniques**: Generates geometric shapes (pentagons) that move organically using Perlin noise. The coordinate space is divided into 12 radial segments, mirrored and duplicated symmetrically using `py5.push_matrix`, `py5.rotate`, and `py5.scale`. Additive blending and motion blur create a glowing, hypnotic effect.
- **Palette**: Rich golds, ambers, and deep crimsons against a dark background, evoking mystical or cosmic energy.

## kinetic_math_strange_attractor_clifford_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A visualization of the Clifford strange attractor continuously morphing its defining parameters over time. 300,000 independent particles trace out the attractor's complex, folding fractal structure.
- **Techniques**: Highly optimized NumPy vectorization iterating the Clifford map equations for 300,000 points simultaneously. The points are drawn with very low opacity to build up a density map, creating ghostly, smooth motion blur.
- **Palette**: Monochromatic-adjacent glowing structure that shifts gradually from cyan to magenta, built up through additive blending on a deep dark background.

## kinetic_abstract_geometric_voronoi_stain_glass_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A continuously shifting and morphing Voronoi diagram that resembles liquid, animated stained glass.
- **Techniques**: Uses SciPy's `Voronoi` to compute the geometric regions of 100 points wandering through a Perlin noise field. A ring of phantom points ensures all visible regions remain finite and renderable.
- **Palette**: Deep, rich stained glass hues (reds, blues, yellows, purples) with bold, dark dividing lines.

## kinetic_organic_flocking_boids_nebula_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: 2,500 glowing particles (boids) flocking in a 2D space, exhibiting collective behavior and leaving a fading trail. They behave like a fluid, intelligent nebula or a giant swarm of deep-sea bioluminescence.
- **Techniques**: A highly optimized, fully vectorized flocking algorithm using SciPy's `cKDTree.sparse_distance_matrix` to compute nearest neighbors extremely fast. The density of the flock dynamically changes each boid's color in real time.
- **Palette**: "Nebula" colors: Deep space blues and purples in sparse areas, shifting up to hot pink and bright cyan in densely packed clusters.

## kinetic_generative_spirograph_lissajous_web_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A mesmerizing complex web of lines generated by multiple interlocking Lissajous/harmonograph curves. The moving "pen" connects back to its own history, creating intricate, glowing geometric thread-art.
- **Techniques**: Computes a continuous path using four combined sine/cosine frequencies with evolving phase shifts. The current point is connected via lines to older points in a rolling history buffer at specific phase intervals, forming a structural web.
- **Palette**: Deep magenta to cyan gradients with additive blending over a dark purple background, mimicking glowing thread or laser light.

## kinetic_organic_bubble_foam_packing_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: An organic, continuous circle packing algorithm. Circles spawn and grow until they hit each other. Each has a finite lifespan before popping, leaving space for new circles and creating a boiling, foam-like kinetic texture.
- **Techniques**: Uses optimized NumPy broadcasting to check collisions between 1,500 growing bubbles every frame. Rendered using transparent fills and bright edges.
- **Palette**: Deep ocean blues and bioluminescent cyan against a dark copper background, resembling sea foam or alien soap bubbles.

## kinetic_abstract_vector_field_wheat_waves_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: Thousands of tiny lines (vectors) arranged in a dense grid, all rotating according to an evolving procedural noise vector field, creating a visual effect similar to a field of wheat waving in the wind.
- **Techniques**: Computes a fast 2D procedural noise field using combining sine and cosine functions. Maps the resulting angles to line orientations and colors, drawn efficiently via `py5.begin_shape(py5.LINES)`.
- **Palette**: "Golden Hour" palette: rich gold, amber, and deep brown, glowing against a dark background with a slight fade trail.
...
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A visualization of deterministic chaos. 25,000 double pendulums start with infinitesimally small differences in their initial angles, eventually separating into an expanding, swirling chaotic fractal cloud.
- **Techniques**: Simulates the exact differential equations of motion for 25,000 double pendulums simultaneously using NumPy vectorization. The end effectors are drawn with additive blending.
- **Palette**: Deep cyan and magenta representing the slight phase differences between the pendulums, creating a glowing cloud of chaos.

## kinetic_algorithmic_botanical_fractal_bloom_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: An algorithmic flower that recursively blooms, folds, and rotates. The branches split recursively into intricate patterns with organic, continuous breathing motion.
- **Techniques**: A recursive depth-based L-system logic rendered in 2D using `py5` transforms (`push_matrix()`, `pop_matrix()`). Branching angles and lengths are driven by sinusoidal waves that ripple through the depth of the recursion.
- **Palette**: Deep emerald green bases transitioning to bright bioluminescent pinks and whites at the fractal tips, using additive blending on a dark background.

## kinetic_abstract_geometric_truchet_tiles_maze_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A constantly evolving Truchet tile maze. Tiles rotate smoothly, continuously creating and destroying winding geometric paths.
- **Techniques**: A grid of tiles where each tile contains curved arcs. A 2D array stores the continuous rotation state. A 2D sine/cosine noise wave passes over the grid, triggering smooth rotations between 0 and 90 degrees.
- **Palette**: Neon cyber-colors mapped to the spatial coordinates, leaving a faint glowing trail behind moving paths.
...
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A simulation of an accretion disk around a binary black hole system. 150,000 glowing particles orbit the singularities, getting accelerated, color-shifted by speed, and swept into glowing rings.
- **Techniques**: O(N) gravity calculation from two central moving point masses using NumPy. Particles start in a disk and are slowly pulled in or ejected.
- **Palette**: Extremely bright orange, yellow, and white around the cores, with cyan and purple ejections.
...
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A 3D simulation of the classic Lorenz attractor ("butterfly effect").
- **Techniques**: 50,000 points integrated using the Euler method to trace the Lorenz manifold, leaving glowing trails as they orbit the two butterfly lobes. Rendered with additive blending and a slowly rotating 3D camera.
- **Palette**: Velocity-based coloring from fiery orange and magenta (fast) down to deep blue/cyan (slow) against a dark background.

## kinetic_geometric_tesseract_rotation_4d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: Projecting a 4D hypercube (Tesseract) into 3D, and then into 2D. We rotate it in 4D space across the XW and YZ planes, generating a shape that continuously turns itself inside out.
- **Techniques**: 16 vertices connected by 32 edges. Manual 4D rotation matrices, followed by a stereographic projection into 3D, then perspective into 2D. Drawn with 40 nested tesseracts with slightly offset rotation phases.
- **Palette**: Wireframe matrix-green/cyan with additive blending.

## kinetic_attraction_repulsion_particle_life_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: "Particle Life" or simulated artificial chemistry. 4 different colors of particles interact with specific attraction and repulsion forces, creating emergent structures like crawling worms, spinning cells, and crystal lattices.
- **Techniques**: O(N^2) simulation over 4800 particles using numpy to calculate pairwise distances. Softened inverse square forces based on a 4x4 interaction matrix.
- **Palette**: Neon Pink, Cyan, Yellow, and Purple against a dark space background.

## kinetic_quantum_interference_probability_cloud_3d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: Simulating the probability density of an electron orbital (like the Hydrogen atom 4f orbital) using half a million points, slowly rotating the orbital in 3D space.
- **Techniques**: Evaluates a spherical harmonic function combined with a radial distribution over 500,000 points. 3D coordinates are mapped to the probability density function, filtering out points below a probability threshold, and rendered with additive blending while rotating the camera.
- **Palette**: Deep space background. The probability lobes are rendered in glowing cyan and magenta, representing positive and negative phase.

## kinetic_supernova_explosion_shockwave_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A particle simulation of a stellar explosion, with an expanding shockwave of plasma that cools into glowing gas filaments as it expands.
- **Techniques**: 100,000 particles moving outwards with an inverse-square deceleration and random turbulence added to their velocity over time, giving it an organic, stringy, nebular look.
- **Palette**: Intense white/gold at the core, expanding into bright magenta and cooling into deep cyan and purple towards the edges. Additive blending against a pitch black void.

## kinetic_cellular_automata_brians_brain_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A visualization of the "Brian's Brain" cellular automaton, which creates spectacular expanding diamond-like patterns reminiscent of firing neural synapses.
- **Techniques**: Vectorized 2D cellular automata using SciPy's 2D convolution over a 3-state grid (Ready, Firing, Refractory). The grid is continually stimulated by random noise spikes to keep the pattern evolving endlessly.
- **Palette**: Firing cells are brilliant cyan, Refractory are deep purple, and Ready are dark blue space background.

## kinetic_bioluminescent_jellyfish_fractal_2d
- **Date**: 2026-07-03
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A floating, pulsing fractal structure resembling a bioluminescent jellyfish, using recursive trigonometry to create trailing tentacles that respond to a simulated underwater current.
- **Techniques**: Recursive branching where branch length and angle are modulated by a sine wave (breathing) and Perlin noise (current). Trails are rendered using additive transparent polygons.
- **Palette**: Pitch black void, glowing cyan and electric blue tentacles, bright pink/magenta core.
...
- **Date**: 2026-07-02
- **Type**: Animation (900 frames, 60fps)
- **Concept**: Thousands of particles swept up in a turbulent, fluid-like flow generated by Curl Noise. The particles leave glowing trails that twist and fold, mimicking the incompressible chaotic nature of fluid dynamics and smoke.
- **Techniques**: Uses `py5.os_noise()` vectorized over numpy arrays to compute analytical gradients of a 3D noise field, producing a divergence-free (incompressible) vector field. 30,000 particles advect through the field. Trails are drawn using a fading background technique (`py5.rect` with low alpha).
- **Palette**: Dark void background with additive glowing lines mapped across a Gold to Crimson to Magenta gradient.
...
- **Date**: 2026-07-02
- **Type**: Animation (900 frames, 60fps)
- **Concept**: A hypnotic optical illusion generated by two overlapping fields of concentric rings. The slight geometric disparities between the grids create a sweeping, macro-scale interference pattern (Moire effect) that moves independently of the actual drawn geometry.
- **Techniques**: Two independent focal points slowly orbiting the center in opposing phases. Procedurally modulated stroke weights using inverse sine and cosine waves mapped to the phase. High opacity, high contrast vector rendering relying strictly on py5.circle overlaps.
- **Palette**: Stark Off-White background with Deep Indigo lines and Crimson Red focal waves.
...
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An intricate, magical simulation of 40,000 tiny iron filings constantly rotating and aligning themselves to an invisible kinetic magnetic field.
- **Techniques**: Three "North" poles and three "South" poles orbit each other invisibly in the center of the canvas. These poles are driven by seamless looping Lissajous patterns with a touch of Perlin noise. The canvas is filled with 40,000 iron filing points. For every frame, the exact 2D magnetic field vector is computed at every point by summing the forces from all 6 poles using the inverse-square law ($F = \frac{1}{r^2}$). To ensure optimal performance, this massive calculation is fully vectorized using NumPy. The filings do not move their positions; instead, they simply rotate in place like tiny compass needles to trace the invisible magnetic flux lines.
- **Palette**: The background is a very dark, metallic gunmetal gray. The 40,000 filings are bright, glowing silver/white line segments rendered with additive blending and a subtle motion blur overlay so the magnetic flux trails glow vibrantly. The poles themselves are completely invisible.

## abstract_optical_illusion_truchet_tiles_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An optical illusion of constantly shifting mazes and loops. Thousands of individual Truchet tiles rotate dynamically to organically assemble and disassemble massive interconnected paths.
- **Techniques**: The 4K canvas is filled with over 2,000 Truchet tiles. Rather than rotating them randomly, their rotation angles are smoothly driven by a seamless 2D spatial Perlin noise loop. When `py5.noise()` evaluates between certain thresholds, the tile snaps its rotation by 90-degree increments. To add dynamic kinetic energy to the piece, a "smooth flip" animation is implemented using a Smoothstep ease-function, making the tiles physically spin quickly into their new rotation states when the noise wave washes over them.
- **Palette**: A high-contrast monochrome design. The background is an off-white `#EFEFEF` paper color, and the thick Truchet lines are drawn in dark charcoal `#222222`. Occasionally, vibrant glowing neon-orange circles pop into existence at the tile intersections based on the noise field.

## kinetic_voronoi_stained_glass_fluid_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A fluid, constantly shifting geometric stained-glass window.
- **Techniques**: To generate the mosaic pattern, 600 seed points are scattered across the canvas. `scipy.spatial.Voronoi` calculates the precise mathematical boundaries for each polygon region in real time on the CPU. To create the fluid glass effect, each seed point moves through a 2D Perlin noise space in a circular path: $px = noise(\cos(time), \sin(time))$. This technique ensures an incredibly smooth, organic motion that loops perfectly without any sharp jumps. As the seed points drift past each other, the Voronoi shards smoothly warp, collapse, and expand around them.
- **Palette**: Each point is assigned a unique, vibrant, semi-transparent stained-glass color (randomized `HSB` values). The edges of each glass shard are separated by thick, solid black lines simulating lead came in traditional stained glass.

## kinetic_recursive_fractal_canopy_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An elegant, glowing forest of fractal trees. The branches of these fractal trees dynamically sway and blow as if interacting with a gentle, organic wind passing through the canopy.
- **Techniques**: Instead of an L-System grammar generator, pure programmatic recursion (`draw_branch()`) combined with py5's robust `push_matrix()` and `pop_matrix()` transformation stack is used. A central tree is drawn at recursive depth 13 ($2^{13} = 8,192$ branches), and two background trees are drawn at depth 11 ($2,048$ branches each). To simulate the organic swaying of the wind, the branching angles are continuously modulated by a 2D Perlin noise field evaluated with `py5.noise(time, depth)`. This makes the thinner outer branches sway heavily while the thick trunks stay rooted.
- **Palette**: The tree branches smoothly fade their color mapping as depth increases, transitioning from a deep pink/purple at the base of the trunk to a brilliant, glowing cyan at the outer tips. A subtle motion blur makes the canopy glow.

## abstract_math_lissajous_interference_web_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: Incredibly complex, dense webs of Lissajous curves that slowly rotate, stretch, and interfere with each other. This continuous interference creates intricate, mesmerizing optical moiré-like patterns over time.
- **Techniques**: This animation draws 5 massive Lissajous figures simultaneously, each consisting of 15,000 points. Over the 15 seconds, the internal parametric frequencies $a$, $b$, and phase shifts $\delta$ subtly morph to create beautiful organic shifting and pulsing. A fast NumPy stride trick instantly formats the 75,000 total points into vertex coordinates so that `py5.lines()` can draw the entire massive web instantaneously.
- **Palette**: Thin, translucent glowing lines of Gold, Cyan, Green, Purple, and Pink. When these dense webs organically overlap, the `ADD` blend mode creates intense, bright white interference nodes.

## generative_synthwave_terrain_flight_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An endless, forward-moving 3D wireframe grid representing a retro 1980s synthwave landscape. As the camera flies forward, giant procedurally generated mountains rise and fall below, leading toward an enormous glowing sunset on the horizon.
- **Techniques**: Because this animation is rendered strictly in 2D (without py5's `P3D` engine), a 3D perspective projection algorithm is manually programmed ($X = x / z \times fov$, $Y = y / z \times fov$). The endless mountains are generated using 2D Perlin noise and are drawn row by row. To simulate occlusion without using a traditional 3D depth buffer, the horizontal `QUAD_STRIP` rows are rendered from the furthest $z$ distance to the closest $z$ distance—a classic use case of the Painter's Algorithm.
- **Palette**: The terrain wireframes are colored dynamically based on their height. The deep valleys are dark magenta, while the high mountain peaks glow electric cyan. In the distance, a massive retro sun radiates concentric rings of yellow, pink, and purple.
...
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An incredibly deep, continuous zoom into a highly complex region of the Mandelbrot Set (known as the Seahorse Valley). Over the course of 15 seconds, the camera accelerates exponentially, ultimately zooming in by a magnification factor of 100,000,000,000x ($10^{11}$)!
- **Techniques**: Evaluating the Mandelbrot fractal formula $Z = Z^2 + C$ at this level of magnification requires huge precision. Thankfully, NumPy uses double-precision (`float64`) by default, which allows us to zoom in by a factor of up to $10^{13}$ without suffering from floating-point pixelation. To ensure a beautiful render without visible banding, the escape velocities are mapped using a continuous, fractional logarithm smoothing technique.
- **Palette**: A continuously shifting neon palette of Cyan, Pink, and Deep Blue based on the smooth escape time.

## kinetic_galaxy_n_body_collision_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An N-body gravitational simulation of two massive colliding galaxies. Each galaxy is built as a rotating disk of particles, and they are hurled toward each other to simulate an epic gravitational collision. As they pass through one another, the gravitational tidal forces rip long, beautiful spiral arms and tails out of the original disks.
- **Techniques**: Evaluating the gravitational forces of $N=4,000$ particles means computing an enormous $4,000 \times 4,000$ pairwise distance matrix every single frame using pure NumPy. Because gravity follows the $1/r^2$ inverse-square law, particles can experience infinite acceleration if they get too close to one another, so a mathematical "softening" parameter is added to the denominator to prevent singularities and chaotic numerical explosions.
- **Palette**: Deep glowing blue/cyan for one galaxy, bright fiery orange/red for the other. Additive blending creates intense white/purple energy flashes where they intersect.

## kinetic_boids_flocking_attractors_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: Craig Reynolds' classic "Boids" artificial life algorithm. This algorithm simulates the emergent flocking behavior of birds or schools of fish based on three simple rules: Separation, Alignment, and Cohesion. When applied to 3,000 interacting particles simultaneously, they form beautiful, fluid, self-organizing streams and chaotic schooling patterns.
- **Techniques**: Evaluating the 3 rules for 3,000 birds means calculating 9,000,000 pairwise distances per step. By vectorizing the entire algorithm using `scipy.spatial.distance.cdist` and heavy NumPy array broadcasting, I'm able to run the simulation extremely quickly. I also added an invisible global attractor in the center to gently pull the flocks back onto the screen so they don't wander off.
- **Palette**: Buckets of glowing Red, Green, and Blue trails over a fading background.

## generative_turing_pattern_reaction_diffusion_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: The Gray-Scott Reaction-Diffusion system. This mathematical model simulates the interaction of two virtual chemicals ($U$ and $V$). $U$ is fed at a constant rate, while $V$ kills $U$ and decays over time. The interaction between these two simple rules produces astonishingly organic Turing patterns that look exactly like brain folds, coral reefs, or leopard spots as they grow outward.
- **Techniques**: Simulating this involves solving partial differential equations on a massive 2D grid. This sketch uses the highly optimized `scipy.ndimage.convolve` to apply a 3x3 Laplacian kernel across the array. The simulation runs 25 steps per frame, so the coral-like structures rapidly grow and expand organically from a few randomized seed points in the center.
- **Palette**: A deep glowing cyan, bright blue, and purple color gradient.

## kinetic_curl_noise_vortex_flow_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An abstract fluid dynamics simulation using purely analytical "Curl Noise". Curl noise calculates velocity vectors by taking the cross-product derivative of a mathematical scalar field. Because of the math involved, the resulting vector flow field is perfectly incompressible—meaning particles will trace out stunning, non-intersecting vortex lines and never clump together!
- **Techniques**: This sketch defines a scalar potential field built from nested, oscillating sine and cosine waves. I derived the analytical partial derivatives of that field to create an incompressible vector field. Then, I vectorized 1,000,000 particles and mapped them to the velocity field using Euler integration. To draw the millions of points efficiently, a highly optimized bucketing technique splits the particles by their dominant color channel and draws them using just 3 large `py5.points()` calls per frame. Additive blending allows the overlapping particle trails to build up a beautifully intense glow.
- **Palette**: A glowing map of Red, Green, and Blue additive trails.

## generative_abelian_sandpile_fractal_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: The Abelian Sandpile Model produces incredibly intricate, Persian-rug-like fractal patterns. When a massive number of virtual "sand grains" are dropped into the center of a grid, any cell that accumulates 4 or more grains topples over, sending exactly 1 grain to each of its 4 cardinal neighbors. As the toppling cascades outward, complex, perfectly symmetrical geometric patterns naturally emerge.
- **Techniques**: Because toppling cascades can easily take billions of iterations in Python, this sketch completely vectorizes the logic using 2D NumPy array masks and `np.roll` shifts. The simulation runs 250 topple steps per frame. Over 15 seconds, millions of sand grains are dropped into the center, generating a spectacular expanding fractal.
- **Palette**: Neon Pink, Bright Orange, Electric Cyan, and Deep Space Blue.

## generative_domain_warping_liquid_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: Nested noise equations (domain warping) where the mathematical grid coordinates are themselves continuously displaced by noise functions. This creates a deeply organic, fluid-like marble liquid painting effect.
- **Techniques**: Evaluating multi-octave 2D noise across an entire 4K grid pixel-by-pixel in Python would be extremely slow. To perfectly vectorize it, this sketch uses pure NumPy to evaluate layers of nested complex `sin()` and `cos()` wave interferences. This runs incredibly fast at half resolution (1920x1080), extracting beautiful organic contours mapped perfectly to a trigonometric ocean/pearl color palette, before upscaling.
- **Palette**: Iridescent pearl and deep ocean blues with glowing white contours.

## kinetic_chaos_game_fractal_mandala_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An animated and kaleidoscopic take on the "Chaos Game", a mathematical process that draws geometric fractals (like the Sierpinski pentagon) through millions of localized point jumps towards random vertices.
- **Techniques**: Instead of letting a single point jump millions of times (which would take too long per frame in Python), this sketch initializes an array of 500,000 points in NumPy. Every frame, these 500k points simultaneously pick a random target vertex and jump towards it. By animating the position of the vertices (a slow rotation) and smoothly oscillating the jump distance modifier using sine waves, the structure breathes and morphs continuously. The points are drawn with heavy transparency using `py5.blend_mode(ADD)`, leaving beautiful glowing density histograms.
- **Palette**: Additive blend colors grouped by their target vertex (Red, Green, Blue, Yellow, Cyan) on a fading black background.

## generative_hodgepodge_machine_bz_reaction_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A continuous digital cellular automata mimicking the Belousov-Zhabotinsky (BZ) chemical reaction. The BZ reaction is famous for producing perfectly mesmerizing, self-organizing concentric spiral waves that expand outward like fluid interference patterns.
- **Techniques**: Utilizes the "Hodgepodge Machine" cellular automaton model, operating across a grid with 100 possible infection/illness states. Because calculating an 8-neighbor sum and evaluating complex infection rules across hundreds of thousands of cells is incredibly slow in pure Python, it uses `np.roll()` across 8 directional axes to perfectly vectorize the entire 2D neighborhood calculation natively in NumPy's C backend. The grid states are then mapped through a continuous trigonometric cosine function to generate a seamless, beautiful fire/magma color gradient.
- **Palette**: Deep neon blue background with states mapped smoothly through magenta, pink, orange, and yellow.

## generative_differential_line_growth_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A continuous differential line growth algorithm simulating biological cellular expansion, slowly blooming into intricate, brain-like or fingerprint-like patterns.
- **Techniques**: Differential line growth requires applying local repulsion forces while maintaining segment connectivity and handling dynamic subdivision as segments grow too long. This becomes computationally expensive $O(N^2)$ and generally destroys rendering speeds with thousands of nodes. To optimize this, the algorithm uses a pure Python/NumPy integration of `scipy.spatial.KDTree` to rapidly query local spatial neighborhoods in underlying C/C++ every frame. This allows the organic form to efficiently subdivide and grow into thousands of nodes without bottlenecking the real-time Py5 loop.
- **Palette**: Glowing bright orange/gold line on a faint trailing dark purple/black background.

## generative_langtons_ant_colony_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: Thousands of generalized Langton's Ants moving simultaneously on a massive grid, creating chaotic digital noise that eventually collapses into intricate, emergent geometric "highways".
- **Techniques**: Since running a simple loop for 5,000 ants 150 times per frame is quite slow in Python, NumPy advanced indexing is utilized to update the entire colony perfectly in parallel. The grid runs at half resolution (1920x1080) and uses nearest-neighbor upscaling when writing via `py5.image()` to give the tapestries a sharp, crisp pixel-art aesthetic. The colony operates on a 4-state generalized Langton rule (L-R-R-L).
- **Palette**: Deep midnight blue/black background with states mapped to purple, neon pink, and bright cyan. The ants themselves are glowing white dots.

## kinetic_lissajous_web_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A highly complex, glowing neon web woven by 800 interacting nodes moving along overlapping Lissajous curves. The nodes leave glowing light trails as they continuously spin and connect to one another.
- **Techniques**: A massive array of 800 nodes uses purely trigonometric positional updates (`x = A sin(a*t + d)`). In each frame, a 800x800 distance squared matrix is computed using NumPy broadcasting. A dynamic threshold mask extracts all proximal node pairs, returning interlaced coordinates. These are dumped entirely into a single `py5.vertices(points)` call with `LINES` geometry type, making 4K rendering incredibly fast despite checking 640,000 potential connections per frame. Additive blending combined with low opacity trailing rectangles gives the web a luminous neon glow.
- **Palette**: Glowing cyan web lines with magenta nodes on a deep space trailing black/blue background.
...
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: An intense, colorful moving landscape generated using digital slit-scan techniques, evoking a feeling of driving through a neon, glitched 80s cyberpunk city at hyper-speed.
- **Techniques**: A full 4K buffer is maintained directly in a NumPy array. Each frame, the array is shifted to the left by 20 pixels, and a new 20-pixel column of glitchy, mathematically generated "noise" (created from interfering sine and cosine fields) is injected on the right edge. Scanlines and thresholding are applied to make it look like a corrupted retro screen. The numpy array is instantly drawn to the py5 canvas using `py5.create_image_from_numpy`.
- **Palette**: Glitchy black scanlines with bright neon pink/red and cyan.

## kinetic_spirograph_mandala_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A massive, multi-layered spirograph that continuously draws and undraws complex, rotating neon mandalas. The layers shift and morph as if breathing.
- **Techniques**: Utilizing NumPy vectorization to continuously evaluate hypotrochoid equations across 60 slightly offset geometric rings, each consisting of 5000 points. The inner radius and distance constants are animated with sine/cosine functions to make the spirographs morph and warp over time, producing a 3D-like glowing tube effect. Rendered using `py5.begin_shape()` and `py5.vertices()` for continuous line-strip drawing.
- **Palette**: Interpolated spectrum from cyan to purple with pulsing brightness mapped to time.
...
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A mesmerizing geometric spiral based on the golden ratio (phyllotaxis). It expands outwards and constantly rotates, creating a hypnotic zooming vortex of glowing neon seeds.
- **Techniques**: Utilizing NumPy vectorization to continuously evaluate `r = c * sqrt(n)` and `theta = n * 137.5 + t` for 40,000 individual "seeds" in real-time. By splitting the results into radial buckets, the seeds are drawn in massive point batches mapped to neon colors to emulate glowing layers against a dark void. Additive blending creates intense glowing trails.
- **Palette**: Glowing neon yellow, fiery orange, and deep magenta on fading black motion trails.

## generative_voronoi_stained_glass_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A stained glass window made of flowing, morphing mathematical cells. The cells pulse and shift continuously with deep, vibrant cathedral colors.
- **Techniques**: Using `scipy.spatial.Voronoi` to dynamically re-calculate polygon tessellations around 300 floating centroid points at 30fps. The polygon vertices are fed into py5 to draw thick, dark "lead" outlines, while the fills are shaded dynamically based on a spatial sine-wave color function.
- **Palette**: Deep ruby, sapphire, amethyst, and gold separated by dark black lines.
...
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A kinetic optical illusion utilizing overlapping dense geometric grids of radiating lines to create a mind-bending Moiré interference pattern.
- **Techniques**: Two identical sets of 400 radiating lines are generated perfectly on top of each other. The bottom layer is static (though slowly cycling through a neon RGB color phase), while the top layer is drawn in high-contrast black and mathematically translated and rotated over time. This continuous transformation causes the geometric interference pattern to rapidly ripple and shift.
- **Palette**: High-contrast black intersecting lines with cycling neon RGB highlights on a stark white background.

## generative_boids_flocking_swirl_2d
- **Date**: 2026-06-28
- **Type**: Animation (450 frames, 30fps)
- **Concept**: A massive swarm of neon-colored geometric birds flowing through a fluid void, creating a continuous vortex as they chase a moving target while avoiding chaotic wind forces.
- **Techniques**: An O(N) pseudo-flocking simulation implemented using highly optimized NumPy array operations. The 3,000 agents use a Perlin-noise-like flow field, a vortex attractor, and a moving Lissajous target to simulate complex flocking behavior without the heavy O(N^2) all-to-all collision checks.
- **Palette**: Neon Cyan, Violet, and Magenta (mapped by velocity) on fading black motion trails.
...
- **Date**: 2026-06-24
- **Theme**: Intricate mathematical spirals based on the golden ratio (phyllotaxis) that bloom outwards, expanding and shifting colors, reminiscent of sunflowers or pinecones but glowing neon.
- **Technique**: Iterative drawing of points using polar coordinates based on the golden angle ($137.5^\circ$). Points are drawn progressively each frame, and the underlying angle is slightly animated over time to create a twisting, breathing effect as the spiral expands.
- **Description**: An animated 15s sequence of generative algorithmic phyllotaxis spirals in 2D.
...
- **Description**: An animated 15s sequence of an abstract cybernetic particle swarm optimization 3D.
...
- **Description**: An animated 15s sequence of a generative algorithmic maze using depth-first search.
...
- **Description**: An animated 15s sequence of a generative abstract cellular automata Conway's Game of Life 3D.
...
- **Description**: An animated 15s sequence of a generative abstract cybernetic quantum tunneling particles.
...
- **Description**: An animated 15s sequence of generative abstract cybernetic circuit board routing.

## generative_botanical_l-system_bonsai_2d

- **Date**: 2026-06-21
- **Theme**: A generative L-System drawing a complex bonsai tree over time. As it grows, it sprouts leaves that flutter in a simulated wind.
- **Technique**: Generates the full L-System string using a custom axiom and rules. Draws the whole tree each frame, but animates the branch lengths and angles using a 2D noise field (wind) so the bonsai tree sways and its cherry blossom leaves flutter.
- **Description**: An animated 15s sequence of a generative L-system botanical bonsai.
...
- **Description**: An animated 15s sequence of a generative abstract fluid magnetic field lines.
...
- **Description**: An animated 15s sequence of a generative voronoi crystal shatter.
...
- **Description**: An animated 15s sequence of a generative geometric phyllotaxis spiral.
...
- **Description**: An animated 15s sequence of a generative 3D wireframe landscape.
...
- **Description**: An animated 15s sequence of a generative abstract glitch optical flow.

## generative_algorithmic_geometric_fractal_tree_3d

- **Date**: 2026-06-21
- **Theme**: A 3D fractal tree that grows and sways in the wind, made out of simple geometric primitives (boxes) that change color based on depth.
...
- **Description**: An animated 15s sequence of a generative 3D fractal tree.
...
- **Description**: An animated 15s sequence of a generative abstract bacterial colony.
...
- **Description**: An animated 15s sequence of a generative glowing spiral.
...
- **Description**: An animated 15s sequence of a generative isometric cityscape.
...
- **Description**: An animated 15s sequence of generative fluid metallic flow.
...
- **Description**: An animated 15s sequence of a falling neon data stream.
...
- **Description**: An animated 15s sequence of generative quantum superposition clouds in 3D.
...
- **Description**: An animated 15s sequence of a generative mandala tessellation.
...
- **Description**: An animated 15s sequence of a generative 3D crystal growth.
...
- **Description**: An animated 15s sequence of a generative 3D topological mesh.
...
- **Description**: An animated 15s sequence of generative fluid chromatic vortices in 3D.
...
- **Description**: An animated 15s sequence of generative silk strands.
...
- **Description**: An animated 15s sequence of abstract cellular automata crystals.
...
- **Description**: An animated 15s sequence of an ambient volumetric smoke columns simulation.
...
- **Description**: An animated 15s sequence of a generative liquid metal displacement simulation.
...
- **Description**: An animated 15s sequence of a generative algorithmic neural network sparks simulation.
...
- **Description**: An animated 15s sequence of generative liquid crystal interference patterns.
...
- **Description**: An animated 15s sequence of a generative 3D cybernetic fractal glitch cube.
...
- **Date**: 2026-06-06
- **Theme**: A classic synthwave/vaporwave 3D scene featuring a retro-futuristic grid landscape that scrolls endlessly toward the camera, glowing brightly beneath a massive, scanlined digital sun.
- **Technique**: A 3D landscape rendered with `TRIANGLE_STRIP`. The $Z$ elevation is generated by scrolling 2D `os_noise()`. A large static `circle()` in the background represents the sun, overlaid with scrolling rectangular scanlines to mimic retro CRT interference. Colors map from deep purples to hot pinks.
- **Description**: An animated 10s simulation of an endless scrolling synthwave neon terrain.
...
- **Date**: 2026-06-06
- **Theme**: A massive architectural wall made entirely of mechanical camera apertures, rapidly opening and closing to reveal blinding light behind them, moving in synchronized fluid waves.
...
- **Description**: An animated 10s simulation of an industrial yet mesmerizing breathing mechanical structure, revealing pulsing light in hypnotic fluid waves.
...
- **Date**: 2026-06-03
- **Theme**: A complex, intricately geared celestial orrery (a mechanical model of a solar system) made of polished brass and copper.
- **Technique**: Constructing a nested hierarchy of 3D rotations using matrix transformations. The gears and rings are drawn procedurally using `py5.TRIANGLE_STRIP` and `py5.QUAD_STRIP`. Warm, metallic directional lighting creates specular highlights and deep shadows, giving the illusion of solid brass and tarnished copper rotating against a dark, velvety background. A faint wireframe sphere surrounds the entire mechanism like a celestial cage.
- **Description**: An animated 3D simulation of an antique celestial orrery. At the center spins a sphere of deep lapis lazuli, surrounded by a complex array of interlocking brass rings, copper gears, and orbiting planetary bodies. The mechanism is illuminated by warm, directional light that catches the edges of the metallic geometry as the rings rotate at varying speeds on multiple inclined axes. A faint golden wireframe cage surrounds the entire cosmic clockwork.
...
- **Description**: An animated 3D simulation of a gigantic, bioluminescent jellyfish drifting through the abyssal depths. The entity's massive bell pulses rhythmically, its edges rippling as it swims. Beneath it, hundreds of glowing cyan and deep violet tentacles trail endlessly into the darkness, swaying gently in invisible deep-sea currents generated by procedural noise. Additive blending creates a hauntingly beautiful, ghostly translucency.

## kinetic_architectural_origami_3d

- **Date**: 2026-06-03
- **Theme**: A vast, brutalist architectural structure made of massive geometric panels that unfold and fold like origami.
- **Technique**: A 3D grid of interconnected concrete planes. The rotation of each panel on its hinges is driven by a slow, sweeping 2D noise field. Lighting is harsh and directional to emphasize stark shadows on the brutalist surfaces, using `py5.directional_light()`. The interlocking concrete-like panels fold on alternating axes based on their grid parity.
- **Description**: An animated 3D simulation of a brutalist megastructure continuously folding and unfolding itself. The massive concrete panels pivot on alternating axes, driven by an invisible noise field that propagates wave-like mechanical motion across the surface. Harsh directional lighting casts deep, dramatic shadows over the raw concrete geometry, interrupted occasionally by flashes of safety-orange industrial detailing.

## stellar_strange_attractor_plasma_3d

- **Date**: 2026-06-03
- **Theme**: A dense, glowing plasma core representing a magnetic confinement reactor or a star's heart, formed by a shifting strange attractor.
- **Technique**: An implementation of the 3D Aizawa strange attractor. Tens of thousands of points trace the chaotic paths of the attractor in real-time using Euler integration. The primary parameter `c` of the attractor is slowly morphed over time using a sine wave, causing the complex orbital shape to constantly shift and reshape itself. Particles are colored dynamically based on their velocity and position, and drawn with additive blending.
- **Description**: An animated 3D simulation of a massive, roiling plasma core. Thirty thousand individual particles trace the chaotic orbits of the Aizawa strange attractor. The attractor's parameters slowly morph, causing the stellar structure to expand and contract dynamically. The plasma core glows intensely through additive blending, shifting through deep fiery oranges and bright solar yellows, with electric blue streaks shooting through the highest-velocity streams.
...
- **Description**: An animated 3D flight over a holographic data-terrain. The camera glides steadily forward over a shifting, procedural mountain range composed entirely of glowing neon wireframes and translucent blue data-surfaces. As peaks rise above a critical threshold, their wireframes flash into warning red. Ethereal data points float gently above the surface, completing the cybernetic, tactical-map aesthetic.

## parametric_wireframe_orchid_3d

- **Date**: 2026-06-03
- **Theme**: A delicate, intricate mechanical flower (like an orchid) composed entirely of highly detailed 3D wireframes that slowly bloom and unfold in a mathematically precise way.
- **Technique**: Procedurally drawing parametric surfaces (using sine/cosine/exponential functions for petals) rendered as `py5.LINES`. The flower's petals bend outward continuously by modifying the parameter limits or surface normals based on a sine wave linked to the frame count, simulating a continuous opening and closing bloom.
- **Description**: An animated 3D simulation of a mechanical orchid blooming. Drawn entirely with fine, technical wireframe lines against a stark white background, the petals of the flower curl open and closed in a breathing motion. The outer petals are carbon black, inner petals are pale lilac, and the center is a cluster of striking gold stamens.
...
- **Description**: An animated 3D simulation of a massive fluid vector field. Hundreds of luminous ribbons trace the invisible currents of a 3D noise field, twisting and flowing continuously. The ribbons are rendered using quad strips with a trailing history, giving them a physical presence as they snake through the dark navy void in shades of aqua, electric purple, and coral.
...
- **Date**: 2026-06-03
- **Theme**: An abstract visualization of quantum interference patterns. Two large overlapping wave systems intersecting, causing destructive and constructive interference, depicted through thousands of tiny glowing cubes that change color and height based on the wave amplitude.
- **Technique**: A 2D grid rendered in 3D where each cell's Z-height is determined by the sum of two expanding sine waves (interference). The amplitude also dictates the color and the `py5.box()` size, giving a tactile, volumetric feel to a mathematical concept. Random jitter and scale spikes add a glitch aesthetic.
- **Description**: An animated 3D simulation of two intersecting sine waves creating a complex interference pattern on a massive grid of glowing cubes. As the waves ripple outward, constructive and destructive interference alters the color and height of the cubes. Random glitches occasionally strike individual nodes, making them flash white and spike vertically.

## sacred_geometry_crystal_growth_3d

- **Date**: 2026-06-03
- **Theme**: A cluster of glowing, translucent geometric crystals (octahedrons and pyramids) growing and shifting rapidly out of a central core.
- **Technique**: Procedurally spawning 3D geometry from a central nucleus. Crystals scale up and rotate outward, blending via additive blending to simulate intense refraction and glowing energy.
- **Description**: An animated 3D simulation of glowing geometric crystals erupting from a central glowing nucleus. Rendered using custom triangulated octahedron geometry, the shards grow, shrink, and translate outwards in a continuous organic cycle, creating a beautiful display of amethyst and rose quartz light using additive blending.
...
- **Date**: 2026-06-03
- **Theme**: A colossal Dyson sphere megastructure built from intricate interlocking hexagonal and triangular panels, slowly rotating around a blinding white-hot central core.
- **Technique**: 3D generation of a geodesic sphere, where faces are extruded outwards based on 3D noise to simulate architectural panels of varying heights.
- **Description**: An animated 3D simulation of a massive Dyson sphere structure slowly rotating, revealing a blindingly hot core through gaps in its complex, height-varied steel-blue panels.
