...
![Preview](generative_algorithmic_maze_depth_first_search_2d_p1.png)

## Metadata
- **Date**: 2026-06-22
- **Theme**: An animated 15s sequence of a generative maze that builds itself using a randomized depth-first sear
- **Technique**: Unknown
- **Logic Lab Reference**: 
