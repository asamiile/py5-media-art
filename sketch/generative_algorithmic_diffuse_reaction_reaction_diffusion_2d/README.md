...
![Preview](generative_algorithmic_diffuse_reaction_reaction_diffusion_2d_p1.png)

## Metadata
- **Date**: 2026-06-22
- **Theme**: An animated 15s sequence of a reaction diffusion simulation using Gray-Scott model, simulating the c
- **Technique**: Unknown
- **Logic Lab Reference**: 
