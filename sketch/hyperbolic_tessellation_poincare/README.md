...
![Preview](hyperbolic_tessellation_poincare_p1.png)

## Metadata
- **Date**: 2026-05-23
- **Theme**: A dynamic, non-Euclidean geometric fractal exploring the Poincaré disk model and Möbius transformati
- **Technique**: Unknown
- **Logic Lab Reference**: 

## Concept
A dynamic, non-Euclidean geometric fractal exploring the Poincaré disk model and Möbius transformations.
