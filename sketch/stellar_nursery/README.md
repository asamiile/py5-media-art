...
## Technical Details
- **Renderer**: P2D
- **Simulation**: multi-scale fBm spectral noise for gas density
- **Visuals**: narrowband emission palette (Hα/OIII/SII), protostar glow with core+halo, dust extinction, multi-scale bloom post-processing, HDR tone mapping
